...
export default function About(): React.JSX.Element {
  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-4 py-16 bg-stone-900 text-white">
      <div className="grid md:grid-cols-3 gap-10 items-start">
        <div className="md:col-span-2">
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex gap-2"><Briefcase className="w-5 h-5 mt-0.5" /> Engineering Manager, Ads API Platform — Reddit</li>
            <li className="flex gap-2"><Code2 className="w-5 h-5 mt-0.5" /> Strengths: DDD, OLEP, transactional outbox, reliability and API governance</li>
            <li className="flex gap-2"><PenTool className="w-5 h-5 mt-0.5" /> Community: Commisioner for youth basketball and poker organizer</li>
          </ul>
        </div>
        <div className="md:col-span-1">
          <div className="bg-gray-200 rounded-2xl border border-slate-200 p-5 shadow-sm">
            <h3 className="font-medium text-slate-600">Accomplishments</h3>
