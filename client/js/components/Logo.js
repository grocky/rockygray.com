...
class Logo extends Component {
  ...
  handleClick(event: Object) {
    console.log('clicked!!!', this._container);
  ...
  render() {
    ...
    return (
      <svg onClick={this.handleClick} ref={c => this._container = c} className={containerClass} fill={fillColor} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 323">
